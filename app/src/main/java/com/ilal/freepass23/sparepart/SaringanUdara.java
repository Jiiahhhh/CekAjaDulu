...
public class SaringanUdara extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_saringan_udara);

        btnOKE = findViewById(R.id.btnSaringanUdaraOKE);
        btnTIDAK = findViewById(R.id.btnSaringanUdaraTIDAK);
        btnSelesai = findViewById(R.id.btnSaringanUdaraSELESAI);
        edtHarga = findViewById(R.id.edtHargaSaringanUdara);
        edtKomentar = findViewById(R.id.edtKomentarSaringanUdara);
        imgFoto = findViewById(R.id.imgFotoSaringanUdara);
        ...
        btnSelesai.setOnClickListener(v -> {
            ...
            if (resultButton == null || bitmap == null){
                Toast.makeText(SaringanUdara.this, "Harap mengisi field yang tersedia", Toast.LENGTH_LONG).show();
            } else {
                Intent intent = new Intent(SaringanUdara.this, DashboardPage.class);
                intent.putExtra("buttonSaringanUdara", resultButton);
                intent.putExtra("hargaSaringanUdara", resultHarga);
                intent.putExtra("komentarSaringanUdara", resultKomentar);
                intent.putExtra("fotoSaringanUdara", bitmap);
