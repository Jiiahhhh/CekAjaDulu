...
public class DriveBeltSet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_drive_belt_set);

        btnOKE = findViewById(R.id.btnDriveBeltSetOKE);
        btnTIDAK = findViewById(R.id.btnDriveBeltSetTIDAK);
        btnSelesai = findViewById(R.id.btnDriveBeltSetSELESAI);
        edtHarga = findViewById(R.id.edtHargaDriveBeltSet);
        edtKomentar = findViewById(R.id.edtKomentarDriveBeltSet);
        imgFoto = findViewById(R.id.imgFotoDriveBeltSet);
        ...
        btnSelesai.setOnClickListener(v -> {
            ...
            if (resultButton == null || bitmap == null){
                Toast.makeText(DriveBeltSet.this, "Harap mengisi field yang tersedia", Toast.LENGTH_LONG).show();
            } else {
                Intent intent = new Intent(DriveBeltSet.this, DashboardPage.class);
                intent.putExtra("buttonDriveBeltSet", resultButton);
                intent.putExtra("hargaDriveBeltSet", resultHarga);
                intent.putExtra("komentarDriveBeltSet", resultKomentar);
                intent.putExtra("fotoDriveBeltSet", bitmap);
