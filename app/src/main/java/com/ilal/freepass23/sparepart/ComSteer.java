...
public class ComSteer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_com_steer);

        btnOKE = findViewById(R.id.btnComSteerOKE);
        btnTIDAK = findViewById(R.id.btnComSteerTIDAK);
        btnSelesai = findViewById(R.id.btnComSteerSELESAI);
        edtHarga = findViewById(R.id.edtHargaComSteer);
        edtKomentar = findViewById(R.id.edtKomentarComSteer);
        imgFoto = findViewById(R.id.imgFotoComSteer);
        ...
        btnSelesai.setOnClickListener(v -> {
            ...
            if (resultButton == null || bitmap == null){
                Toast.makeText(ComSteer.this, "Harap mengisi field yang tersedia", Toast.LENGTH_LONG).show();
            } else {
                Intent intent = new Intent(ComSteer.this, DashboardPage.class);
                intent.putExtra("buttonComSteer", resultButton);
                intent.putExtra("hargaComSteer", resultHarga);
                intent.putExtra("komentarComSteer", resultKomentar);
                intent.putExtra("fotoComSteer", bitmap);
