...
public class KabelKopling extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kabel_kopling);

        btnOKE = findViewById(R.id.btnKabelKoplingOKE);
        btnTIDAK = findViewById(R.id.btnKabelKoplingTIDAK);
        btnSelesai = findViewById(R.id.btnKabelKoplingSELESAI);
        edtHarga = findViewById(R.id.edtHargaKabelKopling);
        edtKomentar = findViewById(R.id.edtKomentarKabelKopling);
        imgFoto = findViewById(R.id.imgFotoKabelKopling);
        ...
        btnSelesai.setOnClickListener(v -> {
            ...
            if (resultButton == null || bitmap == null) {
                Toast.makeText(KabelKopling.this, "Harap mengisi field yang tersedia", Toast.LENGTH_LONG).show();
            } else {
                Intent intent = new Intent(KabelKopling.this, DashboardPage.class);
                intent.putExtra("buttonKabelKopling", resultButton);
                intent.putExtra("hargaKabelKopling", resultHarga);
                intent.putExtra("komentarKabelKopling", resultKomentar);
                intent.putExtra("fotoKabelKopling", bitmap);
