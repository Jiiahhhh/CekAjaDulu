...
public class OliShockbreaker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oli_shockbreaker);

        btnOKE = findViewById(R.id.btnOliShockbreakerOKE);
        btnTIDAK = findViewById(R.id.btnOliShockbreakerTIDAK);
        btnSelesai = findViewById(R.id.btnOliShockbreakerSELESAI);
        edtHarga = findViewById(R.id.edtHargaOliShockbreaker);
        edtKomentar = findViewById(R.id.edtKomentarOliShockbreaker);
        imgFoto = findViewById(R.id.imgFotoOliShockbreaker);
        ...
        btnSelesai.setOnClickListener(v -> {
            ...
            if (resultButton == null || bitmap == null) {
                Toast.makeText(OliShockbreaker.this, "Harap mengisi field yang tersedia", Toast.LENGTH_LONG).show();
            } else {
                Intent intent = new Intent(OliShockbreaker.this, DashboardPage.class);
                intent.putExtra("buttonOliShockbreaker", resultButton);
                intent.putExtra("hargaOliShockbreaker", resultHarga);
                intent.putExtra("komentarOliShockbreaker", resultKomentar);
                intent.putExtra("fotoOliShockbreaker", bitmap);
