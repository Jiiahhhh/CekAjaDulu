...
public class Busi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnOKE = findViewById(R.id.btnBusiOKE);
        btnTIDAK = findViewById(R.id.btnBusiTIDAK);
        btnSelesai = findViewById(R.id.btnBusiSELESAI);
        edtHarga = findViewById(R.id.edtHargaBusi);
        edtKomentar = findViewById(R.id.edtKomentarBusi);
        imgFoto = findViewById(R.id.imgFotoBusi);
        ...
        btnSelesai.setOnClickListener(v -> {
            ...
            if (resultButton == null || bitmap == null){
                Toast.makeText(Busi.this, "Harap mengisi field yang tersedia", Toast.LENGTH_LONG).show();
            } else {
                Intent intent = new Intent(Busi.this, DashboardPage.class);
                intent.putExtra("buttonBusi", resultButton);
                intent.putExtra("hargaBusi", resultHarga);
                intent.putExtra("komentarBusi", resultKomentar);
                intent.putExtra("fotoBusi", bitmap);
