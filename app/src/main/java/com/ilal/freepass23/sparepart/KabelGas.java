...
public class KabelGas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kabel_gas);

        btnOKE = findViewById(R.id.btnKabelGasOKE);
        btnTIDAK = findViewById(R.id.btnKabelGasTIDAK);
        btnSelesai = findViewById(R.id.btnKabelGasSELESAI);
        edtHarga = findViewById(R.id.edtHargaKabelGas);
        edtKomentar = findViewById(R.id.edtKomentarKabelGas);
        imgFoto = findViewById(R.id.imgFotoKabelGas);
        ...
        btnSelesai.setOnClickListener(v -> {
            ...
            if (resultButton == null || bitmap == null){
                Toast.makeText(KabelGas.this, "Harap mengisi field yang tersedia", Toast.LENGTH_LONG).show();
            } else {
                Intent intent = new Intent(KabelGas.this, DashboardPage.class);
                intent.putExtra("buttonKabelGas", resultButton);
                intent.putExtra("hargaKabelGas", resultHarga);
                intent.putExtra("komentarKabelGas", resultKomentar);
                intent.putExtra("fotoKabelGas", bitmap);
