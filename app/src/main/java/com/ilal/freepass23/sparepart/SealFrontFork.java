...
public class SealFrontFork extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seal_front_fork);

        btnOKE = findViewById(R.id.btnSealFrontForkOKE);
        btnTIDAK = findViewById(R.id.btnSealFrontForkTIDAK);
        btnSelesai = findViewById(R.id.btnSealFrontForkSELESAI);
        edtHarga = findViewById(R.id.edtHargaSealFrontFork);
        edtKomentar = findViewById(R.id.edtKomentarSealFrontFork);
        imgFoto = findViewById(R.id.imgFotoSealFrontFork);
        ...
        btnSelesai.setOnClickListener(v -> {
            ...
            if (resultButton == null || bitmap == null){
                Toast.makeText(SealFrontFork.this, "Harap mengisi field yang tersedia", Toast.LENGTH_LONG).show();
            } else {
                Intent intent = new Intent(SealFrontFork.this, DashboardPage.class);
                intent.putExtra("buttonSealFrontFork", resultButton);
                intent.putExtra("hargaSealFrontFork", resultHarga);
                intent.putExtra("komentarSealFrontFork", resultKomentar);
                intent.putExtra("fotoSealFrontFork", bitmap);
