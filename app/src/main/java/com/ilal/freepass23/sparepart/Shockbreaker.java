...
public class Shockbreaker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnOKE = findViewById(R.id.btnShockbreakerOKE);
        btnTIDAK = findViewById(R.id.btnShockbreakerTIDAK);
        btnSelesai = findViewById(R.id.btnShockbreakerSELESAI);
        edtHarga = findViewById(R.id.edtHargaShockbreaker);
        edtKomentar = findViewById(R.id.edtKomentarShockbreaker);
        imgFoto = findViewById(R.id.imgFotoShockbreaker);
        ...
        btnSelesai.setOnClickListener(v -> {
            ...
            if (resultButton == null || bitmap == null){
                Toast.makeText(Shockbreaker.this, "Harap mengisi field yang tersedia", Toast.LENGTH_LONG).show();
            } else {
                Intent intent = new Intent(Shockbreaker.this, DashboardPage.class);
                intent.putExtra("buttonShockbreaker", resultButton);
                intent.putExtra("hargaShockbreaker", resultHarga);
                intent.putExtra("komentarShockbreaker", resultKomentar);
                intent.putExtra("fotoShockbreaker", bitmap);
