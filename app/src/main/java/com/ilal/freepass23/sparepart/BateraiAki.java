...
public class BateraiAki extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_baterai_aki);

        btnOKE = findViewById(R.id.btnBateraiAkiOKE);
        btnTIDAK = findViewById(R.id.btnBateraiAkiTIDAK);
        btnSelesai = findViewById(R.id.btnBateraiAkiSELESAI);
        edtHarga = findViewById(R.id.edtHargaBateraiAki);
        edtKomentar = findViewById(R.id.edtKomentarBateraiAki);
        imgFoto = findViewById(R.id.imgFotoBateraiAki);
        ...
        btnSelesai.setOnClickListener(v -> {
            ...
            if (resultButton == null || bitmap == null){
                Toast.makeText(BateraiAki.this, "Harap mengisi field yang tersedia", Toast.LENGTH_LONG).show();
            } else {
                Intent intent = new Intent(BateraiAki.this, DashboardPage.class);
                intent.putExtra("buttonBateraiAki", resultButton);
                intent.putExtra("hargaBateraiAki", resultHarga);
                intent.putExtra("komentarBateraiAki", resultKomentar);
                intent.putExtra("fotoBateraiAki", bitmap);
