...
public class Ban extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnOKE = findViewById(R.id.btnBanOKE);
        btnTIDAK = findViewById(R.id.btnBanTIDAK);
        btnSelesai = findViewById(R.id.btnBanSELESAI);
        edtHarga = findViewById(R.id.edtHargaBan);
        edtKomentar = findViewById(R.id.edtKomentarBan);
        imgFoto = findViewById(R.id.imgFotoBan);
        ...
        btnSelesai.setOnClickListener(v -> {
            ...
            if (resultButton == null || bitmap == null) {
                Toast.makeText(Ban.this, "Harap mengisi field yang tersedia", Toast.LENGTH_LONG).show();
            } else {
                Intent intent = new Intent(Ban.this, DashboardPage.class);
                intent.putExtra("buttonBan", resultButton);
                intent.putExtra("hargaBan", resultHarga);
                intent.putExtra("komentarBan", resultKomentar);
                intent.putExtra("fotoBan", bitmap);
