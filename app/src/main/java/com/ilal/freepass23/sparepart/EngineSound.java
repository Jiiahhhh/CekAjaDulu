...
public class EngineSound extends AppCompatActivity {
    ...
    ImageView imgFoto;
    String resultButton, resultHarga="0", resultKomenatar ="-";
    Bitmap bitmap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnOKE = findViewById(R.id.btnEngineSoundOKE);
        btnTIDAK = findViewById(R.id.btnEngineSoundTIDAK);
        btnSelesai = findViewById(R.id.btnEngineSoundSELESAI);
        edtHarga = findViewById(R.id.edtHargaEngineSound);
        edtKomentar = findViewById(R.id.edtKomentarEngineSound);
        imgFoto = findViewById(R.id.imgFotoEngineSound);

        resultKomenatar = edtKomentar.getText().toString();
        ...
        btnSelesai.setOnClickListener(v -> {
            ...
            if (resultButton == null || bitmap == null){
                Toast.makeText(EngineSound.this, "Harap mengisi field yang tersedia", Toast.LENGTH_LONG).show();
            } else {
                Intent intent = new Intent(EngineSound.this, DashboardPage.class);
                intent.putExtra("buttonEngineSound", resultButton);
                intent.putExtra("hargaEngineSound", resultHarga);
                intent.putExtra("komentarEngineSound", resultKomenatar);
                intent.putExtra("fotoEngineSound", bitmap);
