...
public class BearingRodaDepan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bearing_roda_depan);

        btnOKE = findViewById(R.id.btnBearingRodaDepanOKE);
        btnTIDAK = findViewById(R.id.btnBearingRodaDepanTIDAK);
        btnSelesai = findViewById(R.id.btnBearingRodaDepanSELESAI);
        edtHarga = findViewById(R.id.edtHargaBearingRodaDepan);
        edtKomentar = findViewById(R.id.edtKomentarBearingRodaDepan);
        imgFoto = findViewById(R.id.imgFotoBearingRodaDepan);
        ...
        btnSelesai.setOnClickListener(v -> {
            ...
            if (resultButton == null || bitmap == null){
                Toast.makeText(BearingRodaDepan.this, "Harap mengisi field yang tersedia", Toast.LENGTH_LONG).show();
            } else {
                Intent intent = new Intent(BearingRodaDepan.this, DashboardPage.class);
                intent.putExtra("buttonBearingRodaDepan", resultButton);
                intent.putExtra("hargaBearingRodaDepan", resultHarga);
                intent.putExtra("komentarBearingRodaDepan", resultKomentar);
                intent.putExtra("fotoBearingRodaDepan", bitmap);
