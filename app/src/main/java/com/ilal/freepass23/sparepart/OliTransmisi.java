...
public class OliTransmisi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oli_transmisi);

        btnOKE = findViewById(R.id.btnOliTransmisiOKE);
        btnTIDAK = findViewById(R.id.btnOliTransmisiTIDAK);
        btnSelesai = findViewById(R.id.btnOliTransmisiSELESAI);
        edtHarga = findViewById(R.id.edtHargaOliTransmisi);
        edtKomentar = findViewById(R.id.edtKomentarOliTransmisi);
        imgFoto = findViewById(R.id.imgFotoOliTransmisi);
        ...
        btnSelesai.setOnClickListener(v -> {
            ...
            if (resultButton == null || bitmap == null){
                Toast.makeText(OliTransmisi.this, "Harap mengisi field yang tersedia", Toast.LENGTH_LONG).show();
            } else {
                Intent intent = new Intent(OliTransmisi.this, DashboardPage.class);
                intent.putExtra("buttonOliTransmisi", resultButton);
                intent.putExtra("hargaOliTransmisi", resultHarga);
                intent.putExtra("komentarOliTransmisi", resultKomentar);
                intent.putExtra("fotoOliTransmisi", bitmap);
