...
public class RadiatorCoolant extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_radiator_coolant);

        btnOKE = findViewById(R.id.btnRadiatorCoolantOKE);
        btnTIDAK = findViewById(R.id.btnRadiatorCoolantTIDAK);
        btnSelesai = findViewById(R.id.btnRadiatorCoolantSELESAI);
        edtHarga = findViewById(R.id.edtHargaRadiatorCoolant);
        edtKomentar = findViewById(R.id.edtKomentarRadiatorCoolant);
        imgFoto = findViewById(R.id.imgFotoRadiatorCoolant);
        ...
        btnSelesai.setOnClickListener(v -> {
            ...
            if (resultButton == null || bitmap == null){
                Toast.makeText(RadiatorCoolant.this, "Harap mengisi field yang tersedia", Toast.LENGTH_LONG).show();
            } else {
                Intent intent = new Intent(RadiatorCoolant.this, DashboardPage.class);
                intent.putExtra("buttonRadiatorCoolant", resultButton);
                intent.putExtra("hargaRadiatorCoolant", resultHarga);
                intent.putExtra("komentarRadiatorCoolant", resultKomentar);
                intent.putExtra("fotoRadiatorCoolant", bitmap);
