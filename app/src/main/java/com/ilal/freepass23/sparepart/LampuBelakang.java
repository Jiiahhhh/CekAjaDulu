...
public class LampuBelakang extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lampu_belakang);

        btnOKE = findViewById(R.id.btnLampuBelakangOKE);
        btnTIDAK = findViewById(R.id.btnLampuBelakangTIDAK);
        btnSelesai = findViewById(R.id.btnLampuBelakangSELESAI);
        edtHarga = findViewById(R.id.edtHargaLampuBelakang);
        edtKomentar = findViewById(R.id.edtKomentarLampuBelakang);
        imgFoto = findViewById(R.id.imgFotoLampuBelakang);
        ...
        btnSelesai.setOnClickListener(v -> {
            ...
            if (resultButton == null || bitmap == null){
                Toast.makeText(LampuBelakang.this, "Harap mengisi field yang tersedia", Toast.LENGTH_LONG).show();
            } else {
                Intent intent = new Intent(LampuBelakang.this, DashboardPage.class);
                intent.putExtra("buttonLampuBelakang", resultButton);
                intent.putExtra("hargaLampuBelakang", resultHarga);
                intent.putExtra("komentarLampuBelakang", resultKomentar);
                intent.putExtra("fotoLampuBelakang", bitmap);
