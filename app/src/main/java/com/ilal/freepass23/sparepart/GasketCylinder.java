...
public class GasketCylinder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gasket_cylinder);

        btnOKE = findViewById(R.id.btnGasketCylinderOKE);
        btnTIDAK = findViewById(R.id.btnGasketCylinderTIDAK);
        btnSelesai = findViewById(R.id.btnGasketCylinderSELESAI);
        edtHarga = findViewById(R.id.edtHargaGasketCylinder);
        edtKomentar = findViewById(R.id.edtKomentarGasketCylinder);
        imgFoto = findViewById(R.id.imgFotoGasketCylinder);
        ...
        btnSelesai.setOnClickListener(v -> {
            ...
            if (resultButton == null || bitmap == null){
                Toast.makeText(GasketCylinder.this, "Harap mengisi field yang tersedia", Toast.LENGTH_LONG).show();
            } else {
                Intent intent = new Intent(GasketCylinder.this, DashboardPage.class);
                intent.putExtra("buttonGasketCylinder", resultButton);
                intent.putExtra("hargaGasketCylinder", resultHarga);
                intent.putExtra("komentarGasketCylinder", resultKomentar);
                intent.putExtra("fotoGasketCylinder", bitmap);
