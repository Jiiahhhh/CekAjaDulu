...
public class PiringanCakram extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_piringan_cakram);

        btnOKE = findViewById(R.id.btnPiringanCakramOKE);
        btnTIDAK = findViewById(R.id.btnPiringanCakramTIDAK);
        btnSelesai = findViewById(R.id.btnPiringanCakramSELESAI);
        edtHarga = findViewById(R.id.edtHargaPiringanCakram);
        edtKomentar = findViewById(R.id.edtKomentarPiringanCakram);
        imgFoto = findViewById(R.id.imgFotoPiringanCakram);
        ...
        btnSelesai.setOnClickListener(v -> {
            ...
            if (resultButton == null || bitmap == null){
                Toast.makeText(PiringanCakram.this, "Harap mengisi field yang tersedia", Toast.LENGTH_LONG).show();
            } else {
                Intent intent = new Intent(PiringanCakram.this, DashboardPage.class);
                intent.putExtra("buttonPiringanCakram", resultButton);
                intent.putExtra("hargaPiringanCakram", resultHarga);
                intent.putExtra("komentarPiringanCakram", resultKomentar);
                intent.putExtra("fotoPiringanCakram", bitmap);
