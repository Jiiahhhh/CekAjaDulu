...
public class OliMesin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oli_mesin);

        btnOKE = findViewById(R.id.btnOliMesinOKE);
        btnTIDAK = findViewById(R.id.btnOliMesinTIDAK);
        btnSelesai = findViewById(R.id.btnOliMesinSELESAI);
        edtHarga = findViewById(R.id.edtHargaOliMesin);
        edtKomentar = findViewById(R.id.edtKomentarOliMesin);
        imgFoto = findViewById(R.id.imgFotoOliMesin);
        ...
        btnSelesai.setOnClickListener(v -> {
            ...
            if (resultButton == null || bitmap == null){
                Toast.makeText(OliMesin.this, "Harap mengisi field yang tersedia", Toast.LENGTH_LONG).show();
            } else {
                Intent intent = new Intent(OliMesin.this, DashboardPage.class);
                intent.putExtra("buttonOliMesin", resultButton);
                intent.putExtra("hargaOliMesin", resultHarga);
                intent.putExtra("komentarOliMesin", resultKomentar);
                intent.putExtra("fotoOliMesin", bitmap);
