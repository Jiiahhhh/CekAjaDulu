...
public class MinyakRem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_minyak_rem);

        btnOKE = findViewById(R.id.btnMinyakRemOKE);
        btnTIDAK = findViewById(R.id.btnMinyakRemTIDAK);
        btnSelesai = findViewById(R.id.btnMinyakRemSELESAI);
        edtHarga = findViewById(R.id.edtHargaMinyakRem);
        edtKomentar = findViewById(R.id.edtKomentarMinyakRem);
        imgFoto = findViewById(R.id.imgFotoMinyakRem);
        ...
        btnSelesai.setOnClickListener(v -> {
            ...
            if (resultButton == null || bitmap == null){
                Toast.makeText(MinyakRem.this, "Harap mengisi field yang tersedia", Toast.LENGTH_LONG).show();
            } else {
                Intent intent = new Intent(MinyakRem.this, DashboardPage.class);
                intent.putExtra("buttonMinyakRem", resultButton);
                intent.putExtra("hargaMinyakRem", resultHarga);
                intent.putExtra("komentarMinyakRem", resultKomentar);
                intent.putExtra("fotoMinyakRem", bitmap);
