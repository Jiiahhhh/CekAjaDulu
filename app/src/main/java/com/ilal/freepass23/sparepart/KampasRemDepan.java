...
public class KampasRemDepan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kampas_rem_depan);

        btnOKE = findViewById(R.id.btnKampasRemDepanOKE);
        btnTIDAK = findViewById(R.id.btnKampasRemDepanTIDAK);
        btnSelesai = findViewById(R.id.btnKampasRemDepanSELESAI);
        edtHarga = findViewById(R.id.edtHargaKampasRemDepan);
        edtKomentar = findViewById(R.id.edtKomentarKampasRemDepan);
        imgFoto = findViewById(R.id.imgFotoKampasRemDepan);
        ...
        btnSelesai.setOnClickListener(v -> {
            ...
            if (resultButton == null || bitmap == null){
                Toast.makeText(KampasRemDepan.this, "Harap mengisi field yang tersedia", Toast.LENGTH_LONG).show();
            } else {
                Intent intent = new Intent(KampasRemDepan.this, DashboardPage.class);
                intent.putExtra("buttonKampasRemDepan", resultButton);
                intent.putExtra("hargaKampasRemDepan", resultHarga);
                intent.putExtra("komentarKampasRemDepan", resultKomentar);
                intent.putExtra("fotoKampasRemDepan", bitmap);
