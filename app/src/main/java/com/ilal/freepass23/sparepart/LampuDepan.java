...
public class LampuDepan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lampu_depan);

        btnOKE = findViewById(R.id.btnLampuDepanOKE);
        btnTIDAK = findViewById(R.id.btnLampuDepanTIDAK);
        btnSelesai = findViewById(R.id.btnLampuDepanSELESAI);
        edtHarga = findViewById(R.id.edtHargaLampuDepan);
        edtKomentar = findViewById(R.id.edtKomentarLampuDepan);
        imgFoto = findViewById(R.id.imgFotoLampuDepan);
        ...
        btnSelesai.setOnClickListener(v -> {
            ...
            if (resultButton == null || bitmap == null){
                Toast.makeText(LampuDepan.this, "Harap mengisi field yang tersedia", Toast.LENGTH_LONG).show();
            } else {
                Intent intent = new Intent(LampuDepan.this, DashboardPage.class);
                intent.putExtra("buttonLampuDepan", resultButton);
                intent.putExtra("hargaLampuDepan", resultHarga);
                intent.putExtra("komentarLampuDepan", resultKomentar);
                intent.putExtra("fotoLampuDepan", bitmap);
