package com.ilal.freepass23.sparepart;
...
import com.ilal.freepass23.DashboardPage;
import com.ilal.freepass23.R;

import java.text.NumberFormat;
import java.util.Locale;

public class KampasRemBelakang extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kampas_rem_belakang);

        btnOKE = findViewById(R.id.btnKampasRemBelakangOKE);
        btnTIDAK = findViewById(R.id.btnKampasRemBelakangTIDAK);
        btnSelesai = findViewById(R.id.btnKampasRemBelakangSELESAI);
        edtHarga = findViewById(R.id.edtHargaKampasRemBelakang);
        edtKomentar = findViewById(R.id.edtKomentarKampasRemBelakang);
        imgFoto = findViewById(R.id.imgFotoKampasRemBelakang);
        ...
        btnSelesai.setOnClickListener(v -> {
            ...
            if (resultButton == null || bitmap == null){
                Toast.makeText(KampasRemBelakang.this, "Harap mengisi field yang tersedia", Toast.LENGTH_LONG).show();
            } else {
                Intent intent = new Intent(KampasRemBelakang.this, DashboardPage.class);
                intent.putExtra("buttonKampasRemBelakang", resultButton);
                intent.putExtra("hargaKampasRemBelakang", resultHarga);
                intent.putExtra("komentarKampasRemBelakang", resultKomentar);
                intent.putExtra("fotoKampasRemBelakang", bitmap);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 0 && data == null) {
            bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.inputcamera);
